...
export const updateProfile = async (req, res) => {
  try {
    const { username, firstName, lastName, phoneNumber, dateOfBirth, address } = req.body;

    const updateData = {};

    // If username is provided and different, ensure it's not already taken
    if (username) {
      // Normalize trimming
    ...
    // If a uniqueness error from mongoose occurs, provide a clearer message
