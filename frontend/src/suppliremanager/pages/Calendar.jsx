...
import { fetchOrders, createOrder, fetchSuppliers, updateOrder, deleteOrder } from '../../api';
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        <div className="flex items-center mb-8">
          <FontAwesomeIcon icon={faCalendarAlt} className="text-primary-600 text-2xl mr-3" />
          <h1 className="text-3xl font-bold text-primary-600">Order Calendar</h1>
        </div>
        ...
        <div className="mb-6 flex gap-4">
          <button
            onClick={() => openModal()}
            className="bg-primary-500 text-white px-6 py-3 rounded-lg hover:bg-primary-700 inline-flex items-center"
        ...
        >
          <h2 className="text-2xl font-bold mb-6 text-primary-600">{isEditing ? 'Edit Order' : 'Add Order'}</h2>
          ...
          <form onSubmit={submit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary-400 focus:border-primary-400 bg-gray-50 transition-all duration-200 ${formErrors.fruit ? 'border-destructive-red' : 'border-gray-300'}`}
                required
              >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary-400 focus:border-primary-400 bg-gray-50 transition-all duration-200 ${formErrors.quantity ? 'border-destructive-red' : 'border-gray-300'}`}
                required
              />
            ...
            <div className="flex items-end gap-3">
              <div className="flex-1">
                ...
                <select
                  ...
                  className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary-400 focus:border-primary-400 bg-gray-50 transition-all duration-200 ${formErrors.supplier ? 'border-destructive-red' : 'border-gray-300'}`}
                  required
              ...
              <button
                ...
                className={`relative px-4 py-3 rounded-lg inline-flex items-center transition-all duration-200 transform hover:-translate-y-0.5 ${searching ? 'bg-gray-400 cursor-not-allowed' : 'bg-primary-500 text-white hover:bg-primary-700'}`}
              ...
              >
                {searching ? (
                  <>
                    ...
                    Searching...
                    <span className="absolute inset-0 bg-primary-500 opacity-50 rounded-lg animate-pulse" />
                  </>
                ) : (
                  <>
            ...
            {/* Searching messages */}
            {searching && (
              <p className="text-primary-600 font-medium animate-pulse">{searchMessage}</p>
            )}
            {searchMessage && !searching && (
              <p className="text-primary-600 font-medium">{searchMessage}</p>
            )}
            {/* Delivery date input */}
            <div>
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary-400 focus:border-primary-400 bg-gray-50 transition-all duration-200 ${formErrors.deliveryDate ? 'border-destructive-red' : 'border-gray-300'}`}
                required
              />
            ...
            <div>
              ...
              <p className="p-3 bg-gray-100 rounded-lg text-text-primary font-medium">Rs. {(totalPrice ?? 0).toFixed(2)}</p>
            </div>
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-700 transition-all duration-200 transform hover:-translate-y-0.5"
              >
