...
export default function OrderDetails() {
  ...
  const percentage = filteredOrders.length ? ((count / filteredOrders.length) * 100).toFixed(1) : '0.0';
      ...
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-2">
            <FontAwesomeIcon icon={faBox} className="text-primary-600 text-2xl mr-3" />
            <h1 className="text-3xl font-bold text-primary-600">Order Details</h1>
          </div>
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-16">
            <FontAwesomeIcon icon={faSpinner} spin className="text-primary-600 text-4xl mb-4" />
              ...
              <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                ...
                <div className="relative flex-1 min-w-0 w-full lg:w-auto">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400"
                  />
                </div>
                {/* Filter, sort, order */}
                <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
                  <select
                    ...
                    className="p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400"
                  >
                ...
                <div className="flex gap-4 w-full lg:w-auto justify-end">
                  <button
                    onClick={generatePDF}
                    className="bg-primary-500 text-white px-4 py-2 rounded hover:bg-primary-700 flex items-center"
                ...
                filteredOrders.map(order => (
                  <div key={order._id} className="bg-white rounded-lg shadow-sm border p-6 hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start">
                      <div>
                        <h2 className="text-xl font-bold text-primary-600 mb-2">{order.orderId} - {order.fruit}</h2>
                        ...
                        <p className="text-text-secondary mb-1">Price: Rs. {(order.totalPrice ?? 0).toFixed(2)}</p>
                      </div>
                    ...
                    >
                      <div className="border-t pt-4">
                        <h3 className="font-medium mb-2 text-primary-600">Tracking Details</h3>
                        <div className="flex items-center mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <select
                            ...
                            className="p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400 w-48" // Adjusted width with w-48 (192px)
        ...
        >
          {selectedOrder && (
            <>
              <h2 className="text-2xl font-bold mb-4 text-primary-600">Order Details: {selectedOrder.orderId}</h2>
