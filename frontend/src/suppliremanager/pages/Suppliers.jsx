      ...
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          <div className="flex items-center mb-2">
            <FontAwesomeIcon icon={faUsers} className="text-primary-600 text-2xl mr-3" />
            <h1 className="text-3xl font-bold text-primary-600">Supplier Registration</h1>
          </div>
          ...
          <ErrorBoundary>
              ...
              <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="pl-10 pr-8 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-400 bg-white min-w-[180px]"
                  >
                ...
                <button
                  onClick={openModal}
                  className="bg-primary-500 text-white px-6 py-3 rounded-lg hover:bg-primary-700 flex items-center transition-colors shadow-sm"
                >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-primary-600">Add New Supplier</h2>
