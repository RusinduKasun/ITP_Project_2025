    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      ...
      <div className="bg-white p-8 rounded-lg shadow-xl max-w-2xl w-full">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-primary-600">Pending Order Notifications</h2>
          {/* Refresh button එක */}
          <button
            onClick={refreshOrders}
            disabled={refreshLoading}
            className={`bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 inline-flex items-center transition-colors duration-150 ${
              ...
              <div key={order._id} className="border p-4 rounded-lg bg-gray-50">
                ...
                <div className="flex justify-end gap-4 mt-4">
                  <button
                    ...
                    className="bg-primary-500 text-white p-2 rounded hover:bg-primary-700 flex items-center transition-colors duration-150"
