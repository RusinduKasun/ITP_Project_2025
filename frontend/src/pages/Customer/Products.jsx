    ...
    <>
      ...
      <div className="products-page">
        ...
        <button
          ...
          style={{ position: 'fixed', bottom: 24, right: 24, zIndex: 1100, background: '#4caf50', borderRadius: '50%', width: 48, height: 48, boxShadow: '0 2px 8px rgba(44,175,80,0.18)', border: 'none', display: showChatbot ? 'none' : 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}
